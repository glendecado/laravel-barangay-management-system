    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav me-auto gap-2">
                ...
                <li class="nav-item">
                    <a class="nav-link active text-white" href="/resident">Resident</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active text-white" href="/zone-leader">Zone Leader</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active text-white" href="#">chedsck</a>
                </li>
